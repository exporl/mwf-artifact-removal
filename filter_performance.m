function [SER, ARR] = filter_performance(y, d, mask)
...
% Measures artifact estimate in parts with artifacts
...
% ARR
ARR_pc = 10*log10(var(y_corrupt) ./ var(y_corrupt - d_corrupt)); % ARR per channel
